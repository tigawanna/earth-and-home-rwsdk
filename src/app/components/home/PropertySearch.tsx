...
interface PropertySearchProps {
  ...
  compact?: boolean; // Optional prop to control compact mode
}
...
export function PropertySearch({ onSearch, initialParams, compact }: PropertySearchProps) {
  ...
  const handleSearch = () => {
    ...
    const searchQuery: PropertySearchParams = {
      ...
      propertyType:
        searchParams.propertyType !== "Any Type" ? searchParams.propertyType : undefined,
      ...priceRange,
  ...
  return (
    <section className="bg-gradient-to-b from-base-200/50 to-base-300/30 ">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 lg:gap-6 mb-6">
              ...
              <div className="lg:col-span-1">
                <label className="input input-bordered flex items-center gap-2 h-12 lg:h-14 focus-within:input-primary transition-colors">
                  <svg
                    className="w-4 h-4 lg:w-5 lg:h-5 opacity-70"
                    fill="currentColor"
                    viewBox="0 0 20 20">
                    <path
                      fillRule="evenodd"
